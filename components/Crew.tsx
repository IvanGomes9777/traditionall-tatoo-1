      ...
      >
        ...
        >
          ...
          <span className="absolute inset-x-0 bottom-0 block bg-navy/90 px-3 py-2.5 text-center">
            <span className="block font-display text-[0.9375rem] text-cream">{artist.name}</span>
            <span className="block font-script text-[0.75rem] text-gold">{artist.role}</span>
          </span>
        </span>
        ...
        >
          ...
          <span className="absolute inset-0 flex flex-col items-center justify-center gap-2.5 bg-gradient-to-b from-navy/40 to-navy/85 p-4 text-center">
            <span className="font-display text-[1rem] uppercase text-cream">{artist.name}</span>
            <span className="font-body text-[0.8125rem] text-cream">{artist.specialty}</span>
            <a
              href="#kontakt"
              onClick={(e) => e.stopPropagation()}
              className="mt-1.5 bg-gold px-4 py-2.5 font-body text-[0.6875rem] font-bold uppercase tracking-[0.1em] text-navy transition-transform duration-200 hover:scale-105"
            >
              Termin buchen →
            </a>
          </span>
